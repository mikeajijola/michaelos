...
export type Caller = "ui" | "terminal" | "agent" | "navigator" | "hotkey" | "accessibility";
...
export type SurfaceTab = "lily" | "terminal" | "inspector";
...
export type CanonicalCapabilityInvocation = { capabilityId: string; arguments: Record<string, unknown>; actionKeys: string | null; cliCommand: string | null };
