    ...
    sections: [
      {
        ...
        paragraphs: [
          "Most of the conversation about AI and the economy is about productivity. AI can write faster. Code faster. Automate things. Make companies more efficient. Fine. I think all of that is probably true.",
          "But I keep coming back to another question: what if AI becomes a whole new class of consumer?",
          "And I do not just mean an AI buying my train ticket. I mean products that exist because the AI needs them. Money I spend on my AI because I want it to have something. Things an AI decides to buy for itself.",
          "Then take that one step further. What happens when physical and digital environments start being redesigned because machines are important enough users to design around?",
        ],
      ...
      },
      {
        ...
        paragraphs: [
          "Think about dogs. A dog has no salary. It probably has no idea what money is. Yet there are enormous markets for dog food, vets, insurance, toys, hotels and tracking devices. Those markets exist because people have dogs and care about what they need.",
          "The dog door is the bit I find most interesting. The dog has become important enough that somebody physically changes the house around it.",
          "Children make the same point at a much bigger scale. They drive spending, schools, products, entertainment and safety rules without controlling most of the money themselves.",
          "So I do not think being a consumer is only about holding the bank account. Economic activity can gather around something because it spends money, because money is spent on it, or simply because it exists. AI can fit all three.",
        ],
      },
      {
        heading: "Not Everything Is About Productivity",
        paragraphs: [
          "Look at the phone in your pocket. It has a ridiculous amount of compute in it. And what do most of us do with it? Send memes. Talk rubbish in group chats. Watch videos. Take pictures of food. Then two years later we buy an even faster one.",
          "Not everything has to earn its keep through productivity. Sometimes people just want their things to be nicer. Why would AI somehow be exempt from normal consumer behaviour?",
          "People may pay for more memory, a better voice, richer context, more compute, a nicer avatar, greater autonomy or eventually a body. Maybe they give an AI access to a simulated world simply because they want to see what it does. There does not need to be a financial return.",
        ],
        pullQuote: "“I just want mine to be better” can be enough to create a market.",
      },
      {
        heading: "Four Different Kinds of AI Consumption",
        paragraphs: ["This is where I think we need to separate a few things, because they look similar but they really are not."],
        items: [
          ...
          { title: "3. Human buys for AI", body: "A person buys memory, tokens, a better model, an avatar, specialist tools or a body for an AI. Maybe they want it to experiment, or they simply enjoy interacting with it. The purchase does not need a productivity case." },
      ...
      },
      {
        ...
        paragraphs: [
          "‘Buy me the 09:30 train to London’ is AI-mediated demand. I already wanted the journey. The AI just found and bought it.",
          "‘You have £50,000. Improve our engineering organisation’ is different. That agent might decide it needs software, compute, data, training, contractors, security tools or other agents. I did not specify those purchases. They appeared inside its plan.",
          "Economists already have language for parts of this. Derived demand is probably the closest. I am using AI-generated demand because it makes the distinction I care about easier to see.",
          "The AI is still operating inside delegated authority, of course. The funny thing is that the more freedom it has to plan, the more important the boundaries become.",
        ],
      },
      {
        heading: "What Would a Billion AI Agents Buy?",
        paragraphs: ["This is where it gets interesting. Some of these already exist as technical services, but machines could turn them into products that are bought in tiny amounts, at enormous scale."],
        pullQuote: "What are the things no human would ever buy, but a billion AI agents would?",
        items: [
          { title: "Context capacity", body: "Persistent memory and context for maintaining goals, relationships, state and history." },
          { title: "Freshness guarantees", body: "Would an AI pay extra for information guaranteed to be less than five seconds old?" },
          ...
          { title: "Verification and provenance", body: "Would it pay another AI 3p to check a fact independently, and another 1p to show where the fact came from?" },
          ...
          { title: "Physical embodiment", body: "Would it rent a robot arm for twelve seconds, or a drone for one inspection?" },
        ],
      },
      {
        heading: "Every Consumer Has Its Own Ergonomics",
        paragraphs: [
          "Every important kind of user eventually changes the world around it. We adapt homes for dogs, public spaces for children and interfaces for different human needs. Why would machines be different?",
          "Self-driving cars currently use roads made for us. They read traffic lights, metal signs, painted lines and human gestures. But if every vehicle had always been autonomous, would we really have invented traffic lights? Would speed limits be painted onto signs? Would cars need to infer the state of a road from coloured marks?",
          "Probably not. Vehicles might negotiate an intersection directly and receive the rules digitally. The environment would stop translating itself into a form a human driver can understand.",
        ],
      ...
      },
      {
        ...
        paragraphs: [
          "An AI using a website today is often one machine pretending to be a human so it can talk to another machine. It looks for buttons made for a finger or mouse, fills in forms and tries to pull meaning out of a visual sales page.",
          "APIs are better, but I do not even think APIs are necessarily the final answer. They were still largely designed around how human programmers build software.",
          "Maybe the deeper interface is semantic. A company says: here is what I can do, what I sell, what it costs, which rules apply, what I guarantee, who has authority and how you can transact with me. No pretending to click a button required.",
        ],
      ...
      },
      {
        ...
        paragraphs: [
          "I am definitely not claiming that machines becoming customers is my idea. Gartner has been talking about machine customers for years, including in Don Scheibenreif and Mark Raskino’s When Machines Become Customers. Agentic commerce is already making parts of it real.",
          "What I am interested in is pushing that thought a bit further. What happens after the machine becomes an intended user? What happens when people buy things specifically for it, when it develops native resource requirements, and when businesses start redesigning themselves around it?",
        ],
      },
      {
        heading: "Economic Capacitance",
        paragraphs: [
          "I have been playing with a metaphor I call economic capacitance: how much economic activity can gather around this thing over its lifetime? It is a metaphor, not a new economic law.",
          "One billion disposable agents that spend nothing may matter less than ten thousand agents controlling serious budgets. A personal AI that people keep improving for years creates a different footprint again.",
          "Customer lifetime value is probably the closest familiar idea. A child has little direct purchasing authority and still causes enormous lifetime spending. An enterprise agent might direct money outwards. A companion AI might attract spending inwards. A more advanced machine could eventually do both.",
        ],
      },
      {
        heading: "This Does Not Automatically Make the Economy Bigger",
        paragraphs: [
          "So does this mean ten billion AI agents automatically make the economy ten times bigger? Obviously not.",
          "Some spending will just be rerouted. Some automation will destroy existing spending. Some machine-to-machine activity will stay inside one company, and many digital goods are extremely cheap to reproduce. If AI replaces £100,000 of labour and uses £5,000 of compute, we cannot just add the two together and call it new value.",
          "The real opportunity is activity that would otherwise never happen: new machine needs, markets unlocked by lower transaction costs, people spending specifically on AI, new physical infrastructure and genuinely new machine-to-machine trade.",
        ],
      },
      {
        heading: "Physical AI Makes It Easier to See",
        paragraphs: [
          "Robots make all of this easier to see. They need electricity, chargers, parts, servicing, storage, connectivity, insurance, navigation and physical access.",
          "Dogs become important household participants, so houses get dog doors. Machines become important physical participants, so buildings get charging bays, robot-accessible doors, machine pickup areas, automated loading zones and different layouts.",
          "That is what becoming a first-class consumer starts to look like physically. The environment carries evidence that you mattered enough to design around.",
        ],
      ...
      },
      {
        ...
        paragraphs: [
          "Humans care about brand, design, persuasion and experience. An AI may care much more about price, availability, permissions, guarantees, provenance and machine-readable terms. So businesses may need two ways of presenting the same underlying truth.",
          "SEO was an early version of this. Companies changed their websites because machines influenced discovery. But an agent goes further than Google: it may discover the company, compare it, choose it and actually buy from it.",
          "You can already see where this goes. Being searchable by machines is not enough. A business also needs to be legible and actionable to them.",
        ],
      },
      {
        heading: "This Is Where Company as Code Appears",
        paragraphs: [
          "And this is where I realised I had somehow ended up back at Company as Code.",
          "If the customer becomes machine-native, the company eventually needs to become more machine-legible too. An agent needs more than a website. It needs to know what the company can actually do, who is allowed to commit it, which rules and terms apply, what evidence supports a claim and what happens when something goes wrong.",
          "Today that information is scattered across websites, contracts, PDFs, databases, APIs, policies, internal tools and people’s heads. Company as Code is about making those capabilities, rules, authority and evidence explicit and machine-readable. Semantic Alerts is the related question of how that organisation notices when reality changes.",
        ],
      },
      {
        heading: "The Next Consumer Might Not Be Human",
        paragraphs: [
          "The current AI economy mostly sells intelligence to humans. A machine-consumer economy adds people buying things for machines, machines buying things for people, machines buying things for themselves and companies building products mainly because machines need them.",
          "A dog has absolutely no idea why I would ever need LinkedIn. In the same way, I might have no intuitive idea why an AI would pay for ontology translation, twenty milliseconds less latency or twelve seconds with a robot arm.",
          "That does not mean there is no market there. It just means I am not the consumer.",
        ],
